...
for (point_index in 1:n) {
  ...
  distance <- c(as.numeric(dist(rbind(point,group_1_mean),method = "euclidean")) ,as.numeric(dist(rbind(point,group_2_mean),method = "euclidean")), as.numeric(dist(rbind(point,group_3_mean),method = "euclidean")))
  align_group_index <- c(align_group_index,c(which.min(distance)))
}
